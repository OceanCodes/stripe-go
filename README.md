# Go Stripe [![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/OceanCodes/stripe-go) [![Build Status](https://travis-ci.org/stripe/stripe-go.svg?branch=master)](https://travis-ci.org/stripe/stripe-go)
...
```sh
git clone https://github.com/OceanCodes/stripe-go.git
cd stripe-go
...
```sh
go get github.com/OceanCodes/stripe-go
```
...
import (
	...
	"github.com/OceanCodes/stripe-go/client"
)
...
import (
	"github.com/OceanCodes/stripe-go"
	"github.com/OceanCodes/stripe-go/$resource$"
)
...
[godoc]: http://godoc.org/github.com/OceanCodes/stripe-go
[issues]: https://github.com/OceanCodes/stripe-go/issues/new
[package-management]: https://code.google.com/p/go-wiki/wiki/PackageManagementTools
[pulls]: https://github.com/OceanCodes/stripe-go/pulls
